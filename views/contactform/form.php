<main class="flex-1 w-3/5 items-center justify-center bg-slate-600 h-4/5 my-16 rounded-3xl shadow-lg shadow-gray-700/20 border-8 border-solid border-orange-700/60 shadow-inner">
    ...
    <form action="/check/" method="post" class="w-full max-w-md m-auto mt-16">
        <div class="form-group mt-4">
            ...
            <input type="text"
                   ...
                   id="name" name="name" placeholder="Jane Doe">
        </div>
        <div class="form-group mt-4">
        ...
        <div class="form-group mt-4">
            ...
            <textarea
                    ...
                    placeholder="I have a question about... from..."></textarea>
        </div>
        <button type="submit"
